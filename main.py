...
async def save_manual_show_to_db(
  ...
  # SMART EPISODE REPLACEMENT LOGIC
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
  ...
  # 4. DATE ENTRY AFTER UPLOAD (SMART SAME-EPISODE REPLACEMENT)
  if context.user_data.get('awaiting_upload_date'):
    ...
    for vid in pending:
      ...
      # CHECK SAME EPISODE FOR REPLACEMENT
    ...
    msg += f'🤖 <b>सफलतापूर्वक प्रोसेस हुए:</b> <b>{auto_saved} वीडियोस</b>\n'
    ...
    if unmatched_list:
      ...
      unmatch_info = (
          ...
          f'👇 <b>इन सभी {len(unmatched_list)} फाइल्स को एक ही शो में ऐड करने के'
          ' लिए बटन दबाएँ:</b>'
      )
